...
private:
    // Example counts/status (replace with real signals later)
    ...
    // Header icon (unused now that logo is a button, but keep if you need it later)
    TSharedPtr<FSlateBrush> HeaderIcon;
