// ============================================
// Catalyst Landform - Core Model
// ============================================

#pragma once

#include "CoreMinimal.h"
#include "Model/CLStrata.h"     // FCLStrata (collection + sampling)
#include "CLModel.generated.h"

/**
 * Root model for a landform. Units are meters.
 *
...
struct CATALYSTLANDFORM_API FCLModel
{
	GENERATED_BODY()
	...
	/** Strata definition used by generators & graphs. */
