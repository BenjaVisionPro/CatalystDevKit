...
struct CATALYSTECOSYSTEM_API F__PREFIX__ServerSettings
{
	GENERATED_BODY()
public:
	/**
...
class CATALYSTECOSYSTEM_API U__PREFIX__Settings :public UObject
{
	GENERATED_BODY()
public:
...
class CATALYSTECOSYSTEM_API U__PREFIX__EditorSettings : public UObject
{
	GENERATED_BODY()
public:
#if WITH_EDITOR
