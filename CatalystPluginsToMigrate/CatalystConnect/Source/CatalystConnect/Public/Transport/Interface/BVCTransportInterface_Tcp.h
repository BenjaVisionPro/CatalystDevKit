...
/** Placeholder TCP transport (stubbed similarly to WS). */
class CATALYSTCONNECT_API FBVCTransportInterface_Tcp final : public IBVCTransportInterface
{
public:
    ...
    virtual FString  GetDebugName() const override { return TEXT("TCP"); }
