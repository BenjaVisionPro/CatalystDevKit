// ============================================================================
// Catalyst __PLUGIN_DISPLAY_NAME__ — Model Asset Factory (Editor)
// ----------------------------------------------------------------------------
...
UCLASS()
class __PLUGIN_EDITOR_API__ U__PREFIX__ModelAssetFactory : public UFactory
{
	GENERATED_BODY()
...
public:
	...
	virtual FString GetDefaultNewAssetName() const override { return TEXT("New __PLUGIN_DISPLAY_NAME__"); }
};